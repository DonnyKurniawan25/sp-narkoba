...
<body class="hold-transition login-page" style="background-image: url({{asset('assets/images/26363.jpg')}}); background-size: 1700px">
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">Anda harus masuk terlebih dahulu</p>
