...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active"><a href="#"><span class="badge badge-success">Pertanyaan</span></a></li>
</ol>
@endsection
...
$query = "SELECT max(id) as maxKode FROM soal";
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <div class="col-md-6">
                    <h3 class="card-title"><span class="badge badge-primary">Tabel solusi</span></h3>
                </div>
                <div class="col-md-6">
