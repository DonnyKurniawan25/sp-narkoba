...
@section("content-link")
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item active"><a href="#"><span class="badge badge-success">Penyakit</span></a></li>
    </ol>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-6">
                        <h3 class="card-title"><span class="badge badge-primary">Tabel Penyakit</span></h3>
                    </div>
                    <div class="col-md-6">
