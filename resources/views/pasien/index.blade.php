...
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="{{route('beranda.index')}}"><span class="badge badge-primary">Beranda</span></a></li>
    <li class="breadcrumb-item active"><a href="#"><span class="badge badge-success">Pasien</span></li>
    </ol>
    @endsection
    @section("content")
    @include('swal')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="col-md-6">
                        <h3 class="card-title"><span class="badge badge-primary">Tabel pasien</span></h3>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <button type="button"  data-toggle="modal" data-target="#createModalLong" class="btn btn-primary float-right"  >
                            ...
                            <tr>
                                ...
                                <td style="width: 120px">
                                    <form onsubmit="event.preventDefault()" id="myForm-{{ $p->id }}"  method="post" action="{{route('pasien.destroy', $p->id) }}">
                                        <a href="{{ route('pasien.edit', $p->id) }}" class="btn btn-warning fa fa-edit"></a>
                                        {{ csrf_field() }}
                                        {{method_field('DELETE')}}
